...
import {
  ...
  IBusinessScreeningSearchParams
} from "src/types";
...
const BusinessLightScreeningPage: React.FC = () => {
  ...
  const startScreening = () => {
    setIsScreening(true);
    screeningService.screenBusiness(
      searchParameters,
  ...
  const searchParametersChanged = async (params: IBusinessScreeningSearchParams) => {
    setScreeningComplete(false);
    setPristine(false);
...
export default BusinessLightScreeningPage;
